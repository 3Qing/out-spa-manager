<template>
    <el-card class="ac-box">
        ...
        <el-table size="mini" :data="items" border v-if="ocr">
            ...
            <el-table-column label="金額" prop="Amount" min-width="100px">
                <template slot-scope="scope">
                    <el-input
            ...
            <el-table-column label="テキスト" prop="Comment" min-width="140px">
                <template slot-scope="scope">
                    <el-input v-model="scope.row.Comment" size="mini" :maxlength="100"></el-input>
                </template>
            </el-table-column>
            <el-table-column label="部門" :prop="'TeamID'" min-width="140px">
                <template slot-scope="scope">
                    <el-select
            ...
            <el-table-column label="従業員" :prop="'EmployeeID'" min-width="140px">
                <template slot-scope="scope">
                    <el-select
